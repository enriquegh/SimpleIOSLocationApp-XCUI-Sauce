...
curl -OsL https://github.com/enriquegh/SimpleIOSLocationApp/releases/download/v1.1.0/SimpleLocationApp.ipa
curl -OsL https://github.com/enriquegh/SimpleIOSLocationApp/releases/download/v1.1.0/SimpleLocationAppUITests-Runner.ipa
